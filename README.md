...
- **다음 단계 (별도 Phase)**: 실 결제 provider(Stripe/Toss) 연동 — 외부 돈 이동/회계 계약 동반이라 분리. 또는 Phase 8 (call recording + S3/MinIO) 중 우선순위 합의 후 진행
