...
> **현재 단계**: **Phase 8 완료 (call recording v1)** — Phase 7 운영 출시 직전 게이트에 이어 Phase 8 통화 녹취 표면이 closeout됐다. `call_recordings` metadata schema + repository/storage adapter + 5종 REST endpoint + `platform/calls.html` 6-state playback surface + retention worker 90일 cutoff (recording sweep aggregate audit `retention.recordings_deleted` 포함)까지 한 묶음으로 닫혔다. 정본은 [`docs/plan/phase-8/PHASE_8_MASTER.md`](docs/plan/phase-8/PHASE_8_MASTER.md), [`docs/plan/phase-8/PHASE_8_CLOSEOUT_FINDINGS.md`](docs/plan/phase-8/PHASE_8_CLOSEOUT_FINDINGS.md). 데스크탑/브라우저 audio capture pipeline + legal consent UX + 실 S3/MinIO 통합 smoke는 별도 트랙.
> 자세한 계획·결과: [`docs/plan/roadmap/BACKEND_PLAN.md`](docs/plan/roadmap/BACKEND_PLAN.md), [`docs/plan/phase-1/PHASE_1_MASTER.md`](docs/plan/phase-1/PHASE_1_MASTER.md), [`docs/plan/phase-2/PHASE_2_MASTER.md`](docs/plan/phase-2/PHASE_2_MASTER.md), [`docs/plan/phase-3/PHASE_3_MASTER.md`](docs/plan/phase-3/PHASE_3_MASTER.md), [`docs/plan/phase-4/PHASE_4_MASTER.md`](docs/plan/phase-4/PHASE_4_MASTER.md), [`docs/plan/phase-5/PHASE_5_MASTER.md`](docs/plan/phase-5/PHASE_5_MASTER.md), [`docs/plan/phase-6/PHASE_6_MASTER.md`](docs/plan/phase-6/PHASE_6_MASTER.md), [`docs/plan/phase-7/PHASE_7_MASTER.md`](docs/plan/phase-7/PHASE_7_MASTER.md), [`docs/plan/phase-7/PHASE_7_CLOSEOUT_FINDINGS.md`](docs/plan/phase-7/PHASE_7_CLOSEOUT_FINDINGS.md), [`docs/plan/phase-8/PHASE_8_MASTER.md`](docs/plan/phase-8/PHASE_8_MASTER.md), [`docs/plan/phase-8/PHASE_8_CLOSEOUT_FINDINGS.md`](docs/plan/phase-8/PHASE_8_CLOSEOUT_FINDINGS.md), [`docs/plan/phase-6/PHASE_7_HANDOFF.md`](docs/plan/phase-6/PHASE_7_HANDOFF.md). 사용자 가이드: [`docs/USER_GUIDE_PHASE_7.md`](docs/USER_GUIDE_PHASE_7.md), [`docs/USER_GUIDE_PHASE_8.md`](docs/USER_GUIDE_PHASE_8.md) · 시각 가이드: [`docs/product/PHASE_4_FOUNDATIONS.html`](docs/product/PHASE_4_FOUNDATIONS.html), [`docs/product/PHASE_8_FOUNDATIONS.html`](docs/product/PHASE_8_FOUNDATIONS.html) · Phase 8 텍스트 HTML 가이드: [`docs/USER_GUIDE_PHASE_8.html`](docs/USER_GUIDE_PHASE_8.html).
...
- **Phase 7 closeout** ✅: 9개 step 모두 닫힘 + Go/No-Go 9/9 PASS. 종합 결과·검증 명령·남은 리스크·인계 노트는 `docs/plan/phase-7/PHASE_7_CLOSEOUT_FINDINGS.md`
- **Phase 8** ✅ (call recording v1 완료): metadata schema (`call_recordings` 신규 table + `(org_id, call_id)` composite FK + FORCE RLS + retention indexes) + repository (`InCurrentOrg` suffix) + storage adapter boundary (local filesystem two-stage path-traversal 차단 + `@aws-sdk/client-s3` + `@aws-sdk/s3-request-presigner` 실 SDK adapter + sentinel opt-in factory) + 5종 REST endpoint(`/calls/:id/recordings/{upload,finalize,list,playback-url,delete}`, route-scoped error handler) + `platform/calls.html` 6-state recording surface(signed URL을 `audio.src` DOM property로만 결합 + 만료 30초 전 epoch-guarded 자동 갱신 + detail switch/close cleanup) + Phase 7 retention worker 통합(90일 + per-row `retention_delete_after` two-cutoff, `delete_pending` retry, aggregate audit `retention.recordings_deleted`, `KLOSER_RETENTION_RECORDING_*` env). audit/응답/frontend 어디에도 `object_key`/`storage_bucket`/signed URL/checksum 미노출 (substring sentinel로 강제). 852 total / 849 PASS / 3 skipped / 0 fail. closeout: [`docs/plan/phase-8/PHASE_8_CLOSEOUT_FINDINGS.md`](docs/plan/phase-8/PHASE_8_CLOSEOUT_FINDINGS.md). 사용자 가이드: [`docs/USER_GUIDE_PHASE_8.md`](docs/USER_GUIDE_PHASE_8.md) / [`docs/USER_GUIDE_PHASE_8.html`](docs/USER_GUIDE_PHASE_8.html) / 시각 가이드: [`docs/product/PHASE_8_FOUNDATIONS.html`](docs/product/PHASE_8_FOUNDATIONS.html)
- **별도 Phase 후보**: 실 결제 provider(Stripe/Toss) 연동 — 외부 돈 이동/회계 계약 동반이라 Phase 8과 분리. 데스크탑/브라우저 audio capture pipeline은 `docs/plan/roadmap/DESKTOP_APP_PLAN.md` 트랙에서 별도 진행
