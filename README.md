...
> **현재 단계**: **Phase 8 Step 1 완료 / Step 2 대기** — Phase 7은 closeout됐고, Phase 8은 call recording 기능을 schema-first로 시작했다. `call_recordings` metadata schema migration은 적용 완료됐으며 정본은 [`docs/plan/phase-8/PHASE_8_MASTER.md`](docs/plan/phase-8/PHASE_8_MASTER.md), [`docs/plan/phase-8/PHASE_8_STEP_1_PLAN.md`](docs/plan/phase-8/PHASE_8_STEP_1_PLAN.md), [`docs/plan/phase-8/PHASE_8_STEP_1_FINDINGS.md`](docs/plan/phase-8/PHASE_8_STEP_1_FINDINGS.md). S3/MinIO adapter·upload signing·playback UI는 Step 2 이후로 분리한다.
> 자세한 계획·결과: [`docs/plan/roadmap/BACKEND_PLAN.md`](docs/plan/roadmap/BACKEND_PLAN.md), [`docs/plan/phase-1/PHASE_1_MASTER.md`](docs/plan/phase-1/PHASE_1_MASTER.md), [`docs/plan/phase-2/PHASE_2_MASTER.md`](docs/plan/phase-2/PHASE_2_MASTER.md), [`docs/plan/phase-3/PHASE_3_MASTER.md`](docs/plan/phase-3/PHASE_3_MASTER.md), [`docs/plan/phase-4/PHASE_4_MASTER.md`](docs/plan/phase-4/PHASE_4_MASTER.md), [`docs/plan/phase-5/PHASE_5_MASTER.md`](docs/plan/phase-5/PHASE_5_MASTER.md), [`docs/plan/phase-6/PHASE_6_MASTER.md`](docs/plan/phase-6/PHASE_6_MASTER.md), [`docs/plan/phase-7/PHASE_7_MASTER.md`](docs/plan/phase-7/PHASE_7_MASTER.md), [`docs/plan/phase-7/PHASE_7_CLOSEOUT_FINDINGS.md`](docs/plan/phase-7/PHASE_7_CLOSEOUT_FINDINGS.md), [`docs/plan/phase-8/PHASE_8_MASTER.md`](docs/plan/phase-8/PHASE_8_MASTER.md), [`docs/plan/phase-8/PHASE_8_STEP_1_PLAN.md`](docs/plan/phase-8/PHASE_8_STEP_1_PLAN.md), [`docs/plan/phase-8/PHASE_8_STEP_1_FINDINGS.md`](docs/plan/phase-8/PHASE_8_STEP_1_FINDINGS.md), [`docs/plan/phase-6/PHASE_7_HANDOFF.md`](docs/plan/phase-6/PHASE_7_HANDOFF.md). 사용자 가이드: [`docs/USER_GUIDE_PHASE_7.md`](docs/USER_GUIDE_PHASE_7.md) · 시각 가이드: [`docs/product/PHASE_4_FOUNDATIONS.html`](docs/product/PHASE_4_FOUNDATIONS.html).
...
### v1 — MVP (Phase 1~7 완료, Phase 8 시작)
...
- **Phase 8 Step 1** ✅: call recording metadata schema — `call_recordings` 신규 table + `(org_id, call_id)` composite FK → `calls(org_id, id)` + FORCE RLS + app grants + object metadata/status/content-type/checksum/retention indexes. DB에는 audio bytes/signed URL/provider credential을 저장하지 않음. Step 2는 repository + storage adapter boundary
- **별도 Phase 후보**: 실 결제 provider(Stripe/Toss) 연동 — 외부 돈 이동/회계 계약 동반이라 Phase 8과 분리
