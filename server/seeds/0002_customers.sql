...
-- after editing fixture data (status / plan / contact times) refreshes
-- the rows in place.
--
...
INSERT INTO customers (id, org_id, name, company, email, phone, status, plan, last_contacted_at)
VALUES
    ('eeeeeeee-1111-0001-0001-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '김민수', 'Kloser Inc.',  'kim@kloser.com',     '010-1234-5678', 'active',  'Pro',        now() - interval '2 hours'),
    ('eeeeeeee-1111-0002-0002-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '이지은', 'DesignCo.',    'lee@designco.kr',    '010-2345-6789', 'review',  'Pro',        now() - interval '5 hours'),
    ('eeeeeeee-1111-0003-0003-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '박서준', 'Nexus Lab',    'park@nexuslab.io',   '010-3456-7890', 'active',  'Enterprise', now() - interval '6 hours'),
    ('eeeeeeee-1111-0004-0004-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '정유진', 'TerraBase',    'jung@terrabase.kr',  '010-4567-8901', 'active',  'Enterprise', now() - interval '7 hours'),
    ('eeeeeeee-1111-0005-0005-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '최서연', 'OrbitLab',     'choi@orbitlab.com',  '010-5678-9012', 'pending', NULL,         now() - interval '1 day'),
    ('eeeeeeee-1111-0006-0006-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '강지훈', 'SkyNode',      'kang@skynode.kr',    '010-6789-0123', 'active',  'Pro',        now() - interval '1 day 4 hours'),
    ('eeeeeeee-1111-0007-0007-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '한수민', 'GridWorks',    'han@gridworks.io',   '010-7890-1234', 'review',  NULL,         now() - interval '2 days'),
    ('eeeeeeee-1111-0008-0008-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '윤서아', 'MapCore',      'yoon@mapcore.kr',    '010-8901-2345', 'active',  'Enterprise', now() - interval '2 days 3 hours'),
    ('eeeeeeee-1111-0009-0009-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '조성훈', 'DOI',          'cjb@doi-kr.com',     '010-9012-3456', 'active',  'Pro',        now() - interval '3 days'),
    ('eeeeeeee-1111-0010-0010-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '신예린', 'DataFlow',     'shin@dataflow.kr',   '010-0123-4567', 'pending', NULL,         now() - interval '7 days'),
    ('eeeeeeee-1111-0011-0011-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '오민재', 'Pulsar',       'oh@pulsar.io',       '010-1357-2468', 'review',  'Pro',        now() - interval '8 days'),
    ('eeeeeeee-1111-0012-0012-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111',
     '임채영', 'Helix Group',  'lim@helix.co',       '010-2468-1357', 'active',  'Enterprise', now() - interval '14 days')
...
VALUES
    ('ffffffff-2222-0001-0001-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '정승호', 'Beta Soft',      'jung@betasoft.kr',     '010-1111-2222', 'active',  'Pro',        now() - interval '3 hours'),
    ('ffffffff-2222-0002-0002-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '이채린', 'Vector Studio',  'lee@vector.io',        '010-2222-3333', 'active',  'Enterprise', now() - interval '6 hours'),
    ('ffffffff-2222-0003-0003-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '박재훈', 'NorthBridge',    'park@northbridge.com', '010-3333-4444', 'pending', NULL,         now() - interval '12 hours'),
    ('ffffffff-2222-0004-0004-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '김수아', 'Lumix',          'kim@lumix.kr',         '010-4444-5555', 'review',  'Pro',        now() - interval '18 hours'),
    ('ffffffff-2222-0005-0005-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '최민준', 'Coral Networks', 'choi@coral.io',        '010-5555-6666', 'active',  'Pro',        now() - interval '1 day 2 hours'),
    ('ffffffff-2222-0006-0006-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '강하늘', 'PlasmaCore',     'kang@plasmacore.com',  '010-6666-7777', 'active',  'Enterprise', now() - interval '1 day 8 hours'),
    ('ffffffff-2222-0007-0007-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '윤성준', 'Zenith Labs',    'yoon@zenith.kr',       '010-7777-8888', 'review',  'Pro',        now() - interval '2 days'),
    ('ffffffff-2222-0008-0008-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '한지민', 'Cobalt Group',   'han@cobalt.io',        '010-8888-9999', 'pending', NULL,         now() - interval '3 days'),
    ('ffffffff-2222-0009-0009-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '조유나', 'Nimbus Tech',    'jo@nimbus.com',        '010-9999-0000', 'active',  'Enterprise', now() - interval '4 days'),
    ('ffffffff-2222-0010-0010-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '신우진', 'Quartz Inc.',    'shin@quartz.kr',       '010-0000-1111', 'active',  'Pro',        now() - interval '5 days'),
    ('ffffffff-2222-0011-0011-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '오재민', 'Helio Systems',  'oh@helio.io',          '010-1234-9876', 'review',  NULL,         now() - interval '9 days'),
    ('ffffffff-2222-0012-0012-ffffffffffff', '22222222-2222-2222-2222-222222222222',
     '임소연', 'Vertex Co.',     'lim@vertex.com',       '010-9876-1234', 'active',  'Enterprise', now() - interval '13 days')
ON CONFLICT (id) DO UPDATE SET
    name              = EXCLUDED.name,
    company           = EXCLUDED.company,
    email             = EXCLUDED.email,
