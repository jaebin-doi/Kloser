...
- Shared types between server and browser — deferred to Phase 2 (no build step on the static pages today). See `docs/plan/phase-1/PHASE_1_STEP_4_FINDINGS.md` §10.
